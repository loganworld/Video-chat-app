...
class UIHelper {
  // STRING
  static final String createAccount = "ລົງທະບຽນ";
  static final String welcomeBack = "ເຂົ້າລະບົບ";
  static final String name = "Name";
  static final String hello = "Hello";
  static final String email = "Email address";
  static final String phone = "ເບີໂທລະສັບ";
  static final String username = "Username";
  static final String password = "ລະຫັດຜ່ານ";
  static final String login = "Login";
  static final String signIn = "ເຂົ້າລະບົບ";
  static final String signUp = "ລົງທະບຽນ";
  ...
  static final String forgetPassword = "ລືມລະຫັດຜ່ານ?";
  static final String resetPassword = "ຂໍລະຫັດ";
  ...
  static final String phoneRequired = "ທ່ານຕ້ອງປ້ອນເບີໂທລະສັບ";
  ...
  // GLOBAL COLORS
  static const Color SPOTIFY_COLOR = Color(0xFF339966);
